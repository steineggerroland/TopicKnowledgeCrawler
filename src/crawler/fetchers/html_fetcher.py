...
class HtmlFetcher:
    ...
    def fetch(self):
        ...
        try:
            ...
            main_page_html = self.fetch_html(self.source_config["url"])
    ...
    def process_article_block(self, article_block):
        ...
        try:
            ...
            main_page_html = self.fetch_html(main_page_url)
            article = self.extract_article_content(main_page_html, main_page_url)
            if not article:
